...
```{r}
cd /dartfs/rc/nosnapshots/V/VaickusL-nb/EDIT_Students/users/JiQing/Bulk_RNAseq_practice

# Download Single-end reads
sratoolkit.3.1.1-centos_linux64/bin/fasterq-dump SRRxxxxxxx

# Download Paired-end reads
sratoolkit.3.1.1-centos_linux64/bin/fasterq-dump --split-files SRR1039508
```
